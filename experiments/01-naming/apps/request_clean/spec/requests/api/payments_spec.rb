...
RSpec.describe "Api::Payments", type: :request do
  ...
  describe "GET /api/payments" do
    ...
    it "filters by status" do
      request1 = create(:request, client: client, provider: provider)
      request2 = create(:request, client: client, provider: provider)
      create(:payment, :held, request: request1, card: create(:card, client: client))
      create(:payment, request: request2)
