module Api
  class ReviewsController < BaseController
    ...
    def index
      render json: @the_request.reviews.map { |r| review_json(r) }
    end

    def create
      review = @the_request.reviews.new(review_params)
    ...
    def set_request
      @the_request = Request.find_by(id: params[:request_id])
