...
ActiveRecord::Schema[8.1].define(version: 2026_04_06_192657) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.index ["request_id"], name: "index_payments_on_order_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["request_id", "author_type", "author_id"], name: "index_reviews_on_order_id_and_author_type_and_author_id", unique: true
    t.index ["request_id"], name: "index_reviews_on_order_id"
  end
